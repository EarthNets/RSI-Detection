...
from rsidet.core.evaluation import DistEvalHook, EvalHook
from rsidet.datasets import DATASETS, CocoDataset, CustomDataset, build_dataset
...
@patch('rsidet.apis.single_gpu_test', MagicMock)
@patch('rsidet.apis.multi_gpu_test', MagicMock)
