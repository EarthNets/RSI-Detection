...
from rsidet.core.hook import ExpMomentumEMAHook, YOLOXLrUpdaterHook
from rsidet.core.hook.sync_norm_hook import SyncNormHook
from rsidet.core.hook.sync_random_size_hook import SyncRandomSizeHook
...
def test_memory_profiler_hook():
    ...
    with pytest.raises(ImportError):
        from rsidet.core.hook import MemoryProfilerHook
