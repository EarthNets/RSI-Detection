...
from rsidet.apis import (async_inference_detector, inference_detector,
                        init_detector)
from rsidet.utils.contextmanagers import concurrent
from rsidet.utils.profiling import profile_time
...
async def main():
    ...
    if not os.path.exists(checkpoint_file):
        url = ('https://download.openmmlab.com/rsidetection/v2.0'
