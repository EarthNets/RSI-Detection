...
[📘使用文档](https://rsidetection.readthedocs.io/zh_CN/stable/) |
[🛠️安装教程](https://rsidetection.readthedocs.io/zh_CN/stable/get_started.html) |
[👀模型库](https://rsidetection.readthedocs.io/zh_CN/stable/model_zoo.html) |
[🆕更新日志](https://rsidetection.readthedocs.io/en/stable/changelog.html) |
[🚀进行中的项目](https://github.com/open-mmlab/rsidetection/projects) |
[🤔报告问题](https://github.com/open-mmlab/rsidetection/issues/new/choose)
...
我们感谢所有的贡献者为改进和提升 MMDetection 所作出的努力。我们将正在进行中的项目添加进了[GitHub Projects](https://github.com/open-mmlab/rsidetection/projects)页面，非常欢迎社区用户能参与进这些项目中来。请参考[贡献指南](.github/CONTRIBUTING.md)来了解参与项目贡献的相关指引。
...
- [MMDetection](https://github.com/open-mmlab/rsidetection): OpenMMLab 目标检测工具箱
- [MMDetection3D](https://github.com/open-mmlab/rsidetection3d): OpenMMLab 新一代通用 3D 目标检测平台
