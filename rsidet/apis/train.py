...
from rsidet.core import DistEvalHook, EvalHook, build_optimizer
from rsidet.datasets import (build_dataloader, build_dataset,
                            replace_ImageToTensor)
from rsidet.utils import (build_ddp, build_dp, compat_cfg,
...
def init_random_seed(seed=None, device='cuda'):
    ...
    # https://github.com/open-mmlab/rsidetection/issues/6339
