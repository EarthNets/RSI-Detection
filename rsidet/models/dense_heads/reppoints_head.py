...
from rsidet.core import (build_assigner, build_sampler, images_to_levels,
                        multi_apply, unmap)
from rsidet.core.anchor.point_generator import MlvlPointGenerator
from rsidet.core.utils import filter_scores_and_topk
...
class RepPointsHead(AnchorFreeHead):
    ...
    def _get_bboxes_single(self,
        ...
        for level_idx, (cls_score, bbox_pred, priors) in enumerate(
            ...
            # After https://github.com/open-mmlab/rsidetection/pull/6268/,
